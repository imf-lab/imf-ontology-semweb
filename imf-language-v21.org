...
The IMF ontology is designed to meet the following functional requirements:
 ...
 - The users of the IMF language should be subject matter experts (SME). This means that the IMF language must be easy to learn and simple to use, hence it must contain a limited set of vocabulary terms and grammar rules.
...
Terms in the ontology are created following these principles:
  ...
  - All IRIs in the ontology are placed in the namespace `http://ns.imfid.org/imf`. The localname's of IRIs follow these naming conventions:
...
imf:MetadataShape a sh:NodeShape ;
  ...
  sh:property 
    ...
    [ sh:path pav:createdOn  ; sh:minCount 1 ; sh:severity sh:Warning ; sh:message "Element has no created timestamp." ] ,
    [ sh:path pav:createdBy  ; sh:minCount 1 ; sh:severity sh:Warning ; sh:message "Element has no creator." ] .
...
imf:ElementShape a sh:NodeShape ;
  ...
  sh:property
    ...
    [ sh:path imf:partOf ; sh:maxCount 1 ; sh:message "Element cannot be part of multiple Elements."  ] ,
...
imf:classifier a owl:ObjectProperty ;
  ...
  skos:example "[classifier] is used to relate a [Block] that is stated to perform a pumping function to the external resource PUMPING <https://data.posccaesar.org/rdl/RDS9657917>. We then say that the [Block] is classified by PUMPING, or equivalently that the [Block] is an instance of PUMPING." ;
  skos:changeNote 
    "0.2.0 :: Added" ;
  vann:termGroup "elements" ;
  rdfs:subPropertyOf imf:externalReference ;
...
imf:ConnectionPoint a owl:Class ;
  ...
  vs:term_status "unstable" ;
  skos:scopeNote """A [Connection Point] represents a reified [connected to] property instance, using the property [the connected] or subpropertes [the input]/[the output] to relate to the [Terminal]s that are related by the [connected to] property. 
...
** TODO SHACL type shapes

#+NAME: shacl-types
#+BEGIN_SRC ttl :noweb strip-export :tangle out/shacl/imf-types.shacl.ttl :mkdirp yes
<<prefixes>>
...
** SHACL OTTR Template Representation
...
** RDF prototype: imftype-shacl2rdf.py
...
#+BEGIN_SRC python :tangle out/py/imftype-shacl2rdf.py :mkdirp yes
import sys, getopt
import rdflib
...
** OWL class representation: imftype-shacl2owl.py

The following python script translates IMF types in SHACL format to an
OWL Class representation.

#+BEGIN_SRC python :tangle out/py/imftype-shacl2owl.py :mkdirp yes
import sys, getopt
import rdflib
from rdflib import Graph, URIRef, BNode, Literal
...
The example demonstrates:
 ...
 3. Extracting a prototype IMF element instance from the IMF type in
    SHACL format -- using a python script

 4. IMF data/instance validation ...
    1. ... against the IMF terms
    2. ... against the IMF grammar
    3. ... against its IMF type

 5. Translating the IMF type in SHACL format to OWL -- using a python
    script
...
** SHACL validation of IMF data against ...
...
<http://example.com/example/ApplicationStandard> a owl:Class ;
    rdfs:subClassOf imf:Attribute .

<http://example.com/example/ClientRequirementDocument> a owl:Class ;
...
<http://example.com/example/ElectricPower> a owl:Class ;
    rdfs:subClassOf imf:Attribute .

<http://example.com/example/Fluid> a owl:Class ;
    rdfs:subClassOf imf:Attribute .

<http://example.com/example/LiquidPumping> a owl:Class ;
    rdfs:label "Pumping, liquid velocity" ;
    rdfs:subClassOf _:N0c068d12b5e54b36b0a635af5702e8ec,
        _:N1c3888e7aa36405799647f2ac218a880,
        _:N1ee7576f709d4155aeac0937cc7d398a,
        _:N275b5ce938084023b474f1f81b55048c,
        _:N2ccadd76a6764771a225d45eaed4c910,
        _:N30dbf93830084a2bb455e05c472f4c21,
        _:N5e9680824f1546a3873a482786260c95,
        [ a owl:Restriction ;
            owl:minQualifiedCardinality "0"^^xsd:nonNegativeInteger ;
            owl:onClass <http://example.com/example/ApplicationStandard> ;
            owl:onProperty imf:hasAttribute ],
        _:N85ccf5efaa584fdf9fb01e702e9a2830,
        _:N97fb561a24894010b441ca33716377f5,
        _:N9d84178492bf44ab91168fd54bd57f4b,
        _:Naab4e7ce6b2c4e388b9d9326b97ba3a6,
        _:Nb2176cf192b74a00bd515b97f5697a84,
        [ a owl:Restriction ;
            owl:minQualifiedCardinality "0"^^xsd:nonNegativeInteger ;
...
<http://example.com/example/NoiseRequirementStandard> a owl:Class ;
    rdfs:subClassOf imf:Attribute .

<http://example.com/example/PressureDelta> a owl:Class ;
    rdfs:subClassOf imf:Attribute .

<http://example.com/example/PumpingPower> a owl:Class ;
    rdfs:subClassOf imf:Attribute .

<http://example.com/example/RotationalVelocity> a owl:Class ;
    rdfs:subClassOf imf:Attribute .

<http://example.com/example/SuctionPressure> a owl:Class ;
    rdfs:subClassOf imf:Attribute .

<http://example.com/example/VolumetricFlowrate> a owl:Class ;
    rdfs:subClassOf [ a owl:Restriction ;
            owl:minQualifiedCardinality "0"^^xsd:nonNegativeInteger ;
            owl:onDataRange [ a rdfs:Datatype ;
                    owl:onDatatype xsd:integer ;
                    owl:withRestrictions ( [ xsd:minInclusive 10 ] [ xsd:maxInclusive 1000 ] ) ] ;
            owl:onProperty imf:value ],
        [ a owl:Restriction ;
            owl:minQualifiedCardinality "0"^^xsd:nonNegativeInteger ;
...
<http://example.com/example/MechanicalRotationInput> a owl:Class ;
    rdfs:subClassOf _:N46b707eaa5a9464695847ae6d0d3b5b1,
        _:N7c2c75059a104debbc2644e1a6b0c538,
        _:Ne5892405f05243a8849f7541cc8c1b51,
        imf:Terminal .

<http://example.com/example/MediaDatasheet> a owl:Class ;
    rdfs:subClassOf imf:Attribute .

<http://example.com/example/Pressure> a owl:Class ;
    rdfs:subClassOf imf:Attribute .

<http://example.com/example/WaterPumpingTerminal> a owl:Class ;
    rdfs:subClassOf _:N395c29e3cb934f328c525d4e299f5d79,
        _:N4146f5264c82407eaed62302e1116625,
        _:N45f56fd2a0b14d39a9e297cc16b312e0,
        _:Nbb65720e915e477c95c230dbdbdd75d2,
        _:Nf0d6415219eb461489bd21e813f2a782,
        imf:Terminal .

[] a owl:Class ;
    rdfs:subClassOf <http://example.com/example/LiquidPumping> ;
    owl:intersectionOf ( _:Naab4e7ce6b2c4e388b9d9326b97ba3a6 _:N0c068d12b5e54b36b0a635af5702e8ec _:N30dbf93830084a2bb455e05c472f4c21 _:N2ccadd76a6764771a225d45eaed4c910 _:N275b5ce938084023b474f1f81b55048c _:N1c3888e7aa36405799647f2ac218a880 _:N5e9680824f1546a3873a482786260c95 _:N9d84178492bf44ab91168fd54bd57f4b _:N85ccf5efaa584fdf9fb01e702e9a2830 _:N97fb561a24894010b441ca33716377f5 _:Nb2176cf192b74a00bd515b97f5697a84 _:N1ee7576f709d4155aeac0937cc7d398a imf:Block ) .
...
[] a owl:Class ;
    ...
    owl:intersectionOf ( _:N46b707eaa5a9464695847ae6d0d3b5b1 _:Ne5892405f05243a8849f7541cc8c1b51 _:N7c2c75059a104debbc2644e1a6b0c538 imf:Terminal ) .

[] a owl:Class ;
    rdfs:subClassOf <http://example.com/example/WaterPumpingTerminal> ;
    owl:intersectionOf ( _:Nbb65720e915e477c95c230dbdbdd75d2 _:N395c29e3cb934f328c525d4e299f5d79 _:Nf0d6415219eb461489bd21e813f2a782 _:N4146f5264c82407eaed62302e1116625 _:N45f56fd2a0b14d39a9e297cc16b312e0 imf:Terminal ) .

_:N0c068d12b5e54b36b0a635af5702e8ec a owl:Restriction ;
    rdfs:label "T2" ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/MechanicalRotationInput> ;
    owl:onProperty imf:hasInputTerminal .

_:N1c3888e7aa36405799647f2ac218a880 a owl:Restriction ;
    rdfs:label "T3" ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/WaterPumpingTerminal> ;
    owl:onProperty imf:hasOutputTerminal .

_:N1ee7576f709d4155aeac0937cc7d398a a owl:Restriction ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/PumpingPower> ;
    owl:onProperty imf:hasAttribute .

_:N275b5ce938084023b474f1f81b55048c a owl:Restriction ;
    owl:hasValue "SP402" ;
    owl:onProperty imf:symbol .

_:N2ccadd76a6764771a225d45eaed4c910 a owl:Restriction ;
    owl:hasValue imf:functionAspect ;
    owl:onProperty imf:hasAspect .

_:N30dbf93830084a2bb455e05c472f4c21 a owl:Restriction ;
    owl:hasValue <http://example.com/rdl/Pumping> ;
    owl:onProperty imf:classifier .

_:N395c29e3cb934f328c525d4e299f5d79 a owl:Restriction ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/VolumetricFlowrate> ;
    owl:onProperty imf:hasAttribute .

_:N4146f5264c82407eaed62302e1116625 a owl:Restriction ;
    owl:hasValue <http://example.com/rdl/RDS4233125> ;
    owl:onProperty imf:classifier .

_:N45f56fd2a0b14d39a9e297cc16b312e0 a owl:Restriction ;
    owl:hasValue <http://example.com/rdl/WaterMedia> ;
    owl:onProperty imf:medium .

_:N46b707eaa5a9464695847ae6d0d3b5b1 a owl:Restriction ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/ElectricPower> ;
    owl:onProperty imf:hasAttribute .

_:N5e9680824f1546a3873a482786260c95 a owl:Restriction ;
    owl:hasValue "KR" ;
    owl:onProperty <http://www.w3.org/2004/02/skos/core#notation> .

_:N7c2c75059a104debbc2644e1a6b0c538 a owl:Restriction ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/MediaDatasheet> ;
    owl:onProperty imf:hasAttribute .

_:N85ccf5efaa584fdf9fb01e702e9a2830 a owl:Restriction ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/PressureDelta> ;
    owl:onProperty imf:hasAttribute .

_:N97fb561a24894010b441ca33716377f5 a owl:Restriction ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/SuctionPressure> ;
    owl:onProperty imf:hasAttribute .

_:N9d84178492bf44ab91168fd54bd57f4b a owl:Restriction ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/Fluid> ;
    owl:onProperty imf:hasAttribute .

_:Naab4e7ce6b2c4e388b9d9326b97ba3a6 a owl:Restriction ;
    rdfs:label "T1" ;
    owl:minQualifiedCardinality "2"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/WaterPumpingTerminal> ;
    owl:onProperty imf:hasInputTerminal .

_:Nb2176cf192b74a00bd515b97f5697a84 a owl:Restriction ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/Pressure> ;
    owl:onProperty imf:hasAttribute .

_:Nbb65720e915e477c95c230dbdbdd75d2 a owl:Restriction ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/Pressure> ;
    owl:onProperty imf:hasAttribute .

_:Ne5892405f05243a8849f7541cc8c1b51 a owl:Restriction ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/RotationalVelocity> ;
    owl:onProperty imf:hasAttribute .

_:Nf0d6415219eb461489bd21e813f2a782 a owl:Restriction ;
    owl:minQualifiedCardinality "1"^^xsd:nonNegativeInteger ;
    owl:onClass <http://example.com/example/MediaDatasheet> ;
    owl:onProperty imf:hasAttribute .
...
* TODOs [29/68]
 ...
 - [ ] add imnages of r block and termianl to the ontologiy as oaf
   defipiction.
 - [X] +put OWL definition in a table?+
 - [ ] explanation of OWL and SHACL definition.
 - [X] +Should we make a condenced version of chapter 4?+
 ...
 - [X] move Element metadata to separate SHACL file
 - [ ] add RDFS reasoning to SHACL validation
 - [ ] create a SHACL shape for types, e.g., hasValue xor class xor in xor datatype
 - [ ] https://github.com/aidhog/blabel
 - [X] Add exactmatch to https://rds.posccaesar.org/ontology/plm/rdl/PCA_100004033/
 - [ ] ontology of types
   - connect classes and shapes, generate link
 - [ ] add imports to python scrtips
 - [ ] add imports bewtween SHACL shape files?
 ...
 - [X] OTTR templates to create types
 - [ ] OTTR templates to instantiate datamodel
 - [ ] Simpler OTTR templates to create types?
 - [X] bOTTR (SHACL + OTTR) over types to
   - [X] OWL class, issues:
     - equivalent to union of
   - [X] Prototypes, issues:
     - must generate multiple instances for minCount, need programming language
 - [ ] Ontology + SHACL shapes of types?
