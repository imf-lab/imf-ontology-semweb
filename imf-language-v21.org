...
_:MetadataShape a sh:NodeShape ;
  ...
  sh:property
    [ sh:path skos:prefLabel ; sh:minCount 1 ; sh:severity sh:Warning ; sh:message "Missing prefLabel." ] ,
    [ sh:path dc:description ; sh:minCount 1 ; sh:severity sh:Warning ; sh:message "Missing description." ] ,
    [ sh:path pav:version    ; sh:minCount 1 ; sh:severity sh:Warning ; sh:message "Missing version number." ] ,
    [ sh:path pav:createdOn  ; sh:minCount 1 ; sh:severity sh:Warning ; sh:message "Missing created timestamp." ] ,
    [ sh:path pav:createdBy  ; sh:minCount 1 ; sh:severity sh:Warning ; sh:message "Missing creator." ] ;
  skos:changeNote
    "0.2.0 :: Added"
.
...
#+NAME: overview-type
#+BEGIN_SRC plantuml :noweb yes :file out/owl/imf-ontology-type.png
<<plantuml-style>>
...
#+ATTR_LATEX: :width 12cm
#+RESULTS: overview-type
[[file:out/owl/imf-ontology-type.png]]
...
[[file:out/img/imf-patterns-types.png]]


*** Basic SHACL OTTR templates
...
do
  for dat in $data 
  do
    echo "Result of validating RDF data <$dat> against SHACL shape <$shape>:"
    date +'%Y-%m-%d'
