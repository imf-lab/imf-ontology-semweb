...
** Design
*** External ontologies and vocabularies used

 - SKOS
 - SemWeb Vocab Status ontology, https://www.w3.org/2003/06/sw-vocab-status/note.html
...
*** Naming conventions
 ...
 - Properties: lowerCamelCase
   ...
   - "binary properties for reified properties" between IMF classes:
     starting with ~the~
   - object properties to external libraries, datatype properties,
     annotation properties do not start with ~has~, ...
...
<http://ns.imfid.org/imf> a owl:Ontology ;
    ...
    vann:namespaceURI <http://ns.imfid.org> ;
    pav:createdOn "2023-06-30T00:00:00"^^xsd:dateTime ;
    pav:createdBy 
      [ foaf:name "Martin G. Skjæveland" ] ;
    pav:contributedBy
      [ foaf:name "Martin G. Skjæveland" ] ,
      [ foaf:name "Arild Waaler" ] ,
      [ foaf:name "Erlend Fjøsna" ] ;
    skos:changeNote 
...
<<py_aspect_ottr_instances_aspects_EDITED>>
...
imf:Element a owl:Class ;
  ...
  skos:scopeNote "[Element] should not be directly instantiated, instead use one of its subclasses." ;
  skos:changeNote 
    "0.2.0 :: Added" ;
. 
...
imf:BlockShape a sh:NodeShape ;
  ...
  sh:property 
    ...
    [ sh:path skos:hasTerminal ; sh:minCount 1 ; sh:severity sh:Warning ; sh:message "The Block has no Terminal." ] ,     
...
imf:Terminal a owl:Class ;
  ...
  vs:term_status "testing" ;
  skos:definition "A [Terminal] is an [Element] that represents a point of interation or communication for a given [Block] (through the relation [has terminal]), and hence specifies an input and/or output that the [Block] produces and/or receives." ;
  skos:changeNote 
    "0.1.0 :: Added" ;
  rdfs:subClassOf imf:Element ;
  .
...
imf:TerminalShape a sh:NodeShape ;
  ...
  sh:property 
    ...
    [ sh:path imf:direction ; sh:maxCount 1 ; sh:in ( imf:inputDirection imf:outputDirection ) ] ,
...
#+BEGIN_SRC ttl
imf:TerminalFlow a owl:Class ;
  skos:prefLabel "Terminal Flow" ;
  vs:term_status "testing" ;
  skos:definition "[Terminal Flow] is a characteristic of the flow of the [medium] of a [Terminal]." ;
  skos:changeNote 
    "0.2.0 :: Added" ;
  .

imf:inputFlow a owl:NamedIndividual, imf:TerminalFlow ;
  skos:prefLabel "input flow" ;
  vs:term_status "testing" ;
  skos:definition "[input flow] is a [Terminal Flow] that indicates that the flow is incoming to the [Terminal] is characterises." ;
  skos:changeNote 
    "0.2.0 :: Added" .

imf:outputFlow a owl:NamedIndividual, imf:TerminalFlow ;
  skos:prefLabel "output flow" ;
  vs:term_status "testing" ;
  skos:definition "[input flow] is a [Terminal Flow] that indicates that the flow is outgoing from the [Terminal] is characterises." ;
  skos:changeNote 
    "0.2.0 :: Added" .
...
imf:hasFlowDirection a owl:ObjectProperty ;
  skos:prefLabel "has terminal flow" ;
  vs:term_status "testing" ;
  skos:definition "[has terminal flow] relates a [Terminal] *T* to a [Terminal Flow] *F* to specify that *T* has the flow characteristic *F*." ;
  skos:changeNote 
    "0.2.0 :: Added" ;
  rdfs:domain imf:Terminal ;
  rdfs:range imf:TerminalFlow .
#+END_SRC
...
[] ottr:of o-owl-ax:EquivHasValue ;
   ottr:values ( imf:InputTerminal imf:direction imf:inputFlow ) .
...
[] ottr:of o-owl-ax:EquivHasValue ;
   ottr:values ( imf:OutputTerminal imf:direction imf:outputFlow ) .
...
imf:BreakdownPointShape a sh:NodeShape ;
  ...
  sh:property 
    [ sh:path imf:thePart  ; sh:minCount 1 ; sh:maxCount 1 ; sh:class sh:Element ] ,
    [ sh:path imf:theWhole ; sh:minCount 1 ; sh:maxCount 1 ; sh:class sh:Element ] 
.
#+END_SRC
...
imf:ConnectionPointShape a sh:NodeShape ;
  ...
  sh:property 
    [ sh:path imf:theInput  ; sh:maxCount 1 ; sh:class sh:Element ] ,
    [ sh:path imf:theOutput ; sh:maxCount 1 ; sh:class sh:Element ] ,
    [ sh:path imf:theConnected ; sh:maxCount 2 ; sh:class sh:Element ] 
.
#+END_SRC
...
imf:hasAspect a owl:ObjectProperty ;
  ...
  vs:term_status "testing" ;
  skos:definition "[has aspect] is a relation from an [Aspect Element] *E* to an [Aspect] *A* that specfies that *E* has the [Aspect] *A*." ;
  skos:changeNote 
    "0.1.0 :: Added" ;
...
imf:AspectElementShape a sh:NodeShape ;
  ...
  sh:property 
    [ sh:path imf:hasAspect ; sh:minCount 1 ; sh:maxCount 1 ; sh:class sh:Aspect ] 
.
#+END_SRC
...
imf:prefix a owl:AnnotationProperty ;
  ...
  vs:term_status "testing" ;
  skos:definition "[prefix] is a relation from an [Aspect] *A* to a [xsd:string] *s* to specify that *s* is the prefix associated with *A*. Such prefix strings are typically used for identifying the aspect when constructing reference designation system (RDS) identifiers." ;
  skos:example "For examples, see the instances of [Aspect] defined in this ontology." ;
  skos:changeNote 
    "0.1.0 :: Added" ;
...
imf:intraAspectRelation a owl:ObjectProperty ;
  ...
  skos:definition "[intra-aspect relation] a generic relation between [Aspect Element]s *E1* and *E2* such that *E1* and *E2* have the same [Aspect]." ;
  vs:term_status "testing" ;
  skos:changeNote 
    "0.1.0 :: Added" ;
  .
...
imf:interAspectRelation a owl:ObjectProperty ;
  ...
  skos:definition "[inter-aspect relation] a generic relation between [Aspect Element]s *E1* and *E2* such that *E1* and *E2* have different [Aspect]s." ;
  vs:term_status "testing" ;
  skos:changeNote 
    "0.1.0 :: Added" ;
  rdfs:subPropertyOf skos:related ;
...
o-imf:AspectClass [owl:Class ?class, owl:NamedIndividual ?aspect] :: {
  ...
  ottr:Triple(?class, skos:editorialNote, "Generated from corresponding aspect individual")
} .
...
o-imf:InterAspectRelation [owl:ObjectProperty ?property, owl:Class ?aspectClass] :: {
  ...
  ottr:Triple(?property, skos:editorialNote, "Generated from corresponding aspect individual")
} .
#+END_SRC
...
[] ottr:of o-imf:Aspect ;
   ottr:values( imf:functionAspect 'function' '=' '#FFFF00' ) . 
[] ottr:of o-imf:Aspect ;
   ottr:values( imf:locationAspect 'location' '+' '#FF00FF' ) . 
[] ottr:of o-imf:Aspect ;
   ottr:values( imf:productAspect 'product' '-' '#00FFFF' ) . 
[] ottr:of o-imf:Aspect ;
   ottr:values( imf:installedAspect 'installed' '::' '#0000FF' ) . 
...
imf:hasAttribute a owl:ObjectProperty ;
  ...
  vs:term_status "testing" ;
  skos:definition "[has attribute] is a relation between a resource *X* and an [Attribute] *A* that specifies that *X* has the attribute *A*." ;
  skos:changeNote 
    "0.2.0 :: Added" ;
...
imf:AttributeShape a sh:NodeShape ;
  ...
  sh:targetSubjectsOf imf:property, imf:uom, imf:hasQualifier ;
  sh:property 
    ...
    [ sh:path imf:hasQualifier ; sh:maxCount 1 ; sh:class imf:RegularityQualifier ] , 
    [ sh:path imf:hasQualifier ; sh:maxCount 1 ; sh:class imf:RangeQualifier ] , 
    [ sh:path imf:hasQualifier ; sh:maxCount 1 ; sh:class imf:ProvenenceQualifier ] , 
    [ sh:path imf:hasQualifier ; sh:maxCount 1 ; sh:class imf:ScopeQualifier ] ,
    [ sh:path imf:hasQualifier ; sh:minCount 1 ; sh:severity sh:Warning ; sh:message "Attribute has no qualifier." ] 
.
#+END_SRC
...
imf:hasQualifier a owl:ObjectProperty ;
  skos:prefLabel "has qualifier" ;
  vs:term_status "testing" ;
  skos:definition "[has qualifier] is a relation between an [Attribute] *A* and an [Attribute Qualifier] *Q* to specify that *A* is qualified by *Q*." ;
  skos:changeNote 
    "0.2.0 :: Added" ;
  rdfs:domain imf:Attribute ;
...
o-imf:AttributeQualifier [owl:Class ?qualifierClass, NEList<owl:NamedIndividual> ?qualifierInstances] :: {
  ...
  o-owl-ax:SubObjectMaxCardinality(imf:Attribute, "1"^^xsd:nonNegativeInteger, imf:hasQualifier, ?qualifierClass),
...
#+NAME: py_aspect_ottr_qualifiers_EDITED
#+BEGIN_src ttl
...
#+BEGIN_SRC ttl
SELECT DISTINCT ?iri ?label ?type ?status ?definition ?scopeNote ?example ?ed
{
  { ?iri ?x1 ?x2 }
  UNION
  { ?x3 ?iri ?x4 }
...
ORDER BY ?status ?type ?iri
#+END_SRC

#+CALL: py_run_sparql(query=sparql_all_imf_iris)

#+RESULTS:
| ~iri~                      | ~label~                                    | ~type~                   | ~status~   | ~definition~                                                                                                                                                                                                                                                                                                                                                 | ~scopeNote~                                                                                                                                                                                                                                                          | ~example~                                                                                                                                                                                                                                                                       | ~ed~                                                                                                                                                                                                                                                                        |
|----------------------------+--------------------------------------------+--------------------------+------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ~ns1:imf~                  | ~Information Modelling Framework Ontology~ | ~owl:Ontology~           |            |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:color~                | ~color~                                    | ~owl:AnnotationProperty~ | ~testing~  | ~[color] is a relation from a resource *X* to a string identifying a hexadecimal color *c* to specify that the *c* is a color that is associated with *A*.~                                                                                                                                                                                                  | ~[Aspect]s are often associated with a distinct color, which is used in graphical presentations of IMF models.~                                                                                                                                                      | ~For examples, see the instances of [Aspect] defined in this ontology.~                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                             |
| ~imf:prefix~               | ~prefix~                                   | ~owl:AnnotationProperty~ | ~testing~  | ~[prefix] is a relation from an [Aspect] *A* to a [xsd:string] *s* to specify that *s* is the prefix associated with *A*. Such prefix strings are typically used for identifying the aspect when constructing reference designation system (RDS) identifiers.~                                                                                               |                                                                                                                                                                                                                                                                      | ~For examples, see the instances of [Aspect] defined in this ontology.~                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                             |
| ~imf:symbol~               | ~symbol~                                   | ~owl:AnnotationProperty~ | ~testing~  | ~[symbol] associates a resource *X* with a typical graphical representation of *X*.~                                                                                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:Aspect~               | ~Aspect~                                   | ~owl:Class~              | ~testing~  | ~An [Aspect] describes a context for interpreting [Element]s. An [Aspect] specifies a /perspective/, an /interest/, and a /modality/. /Perspective/ refers to from which viewpoint the [Element] is interpreted. /Interest/ refers to the scope for which the information is intended used. /Modality/ refers to the form in which information is recorded.~ | ~Aspect is a core concept of ISO/IEC 81346 and the IMF ontology includes aspects that are found in ISO/IEC 81346: function, location and product. We anticipate that more aspects will be added to support future modelling needs.~                                  | ~For examples, see the instances of [Aspect] defined in this ontology.~                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                             |
| ~imf:AspectElement~        | ~Aspect Element~                           | ~owl:Class~              | ~testing~  | ~An [Aspect Element] is an [Element] that has exactly one [Aspect].~                                                                                                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:Attribute~            | ~Attribute~                                | ~owl:Class~              | ~testing~  | ~An [Attribute] describes a quality or characteristic of a resource by setting a [property], a [value], and optionally a [unit of measure].~                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                      | ~Color: red~                                                                                                                                                                                                                                                                    |                                                                                                                                                                                                                                                                             |
| ~imf:Attribute~            | ~Attribute~                                | ~owl:Class~              | ~testing~  | ~An [Attribute] describes a quality or characteristic of a resource by setting a [property], a [value], and optionally a [unit of measure].~                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                      | ~Maximum ambient operating temperature: 120 K~                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                             |
| ~imf:Attribute~            | ~Attribute~                                | ~owl:Class~              | ~testing~  | ~An [Attribute] describes a quality or characteristic of a resource by setting a [property], a [value], and optionally a [unit of measure].~                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                      | ~Weight: 1250 kg~                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                                                                             |
| ~imf:AttributeGroup~       | ~Attribute Group~                          | ~owl:Class~              | ~testing~  | ~An [Attribute Group] is a collection of [Attribute]s which are typically grouped for convenience as they describe closely related features or characteristics of a resource.~                                                                                                                                                                               |                                                                                                                                                                                                                                                                      | ~The physical dimensions of a product, e.g., its length, width and height, could be grouped in an [Attribute Group].~                                                                                                                                                           | ~Does an [Attribute Group] add any semantics? -- what is the difference from an [Attribute Group] and an [Element] with [Attribute]s?~                                                                                                                                      |
| ~imf:AttributeQualifier~   | ~Attribute Qualifier~                      | ~owl:Class~              | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:Block~                | ~Block~                                    | ~owl:Class~              | ~testing~  | ~A [block] is an [element] that ???~                                                                                                                                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:Element~              | ~Element~                                  | ~owl:Class~              | ~testing~  | ~An [Element] represents an abstraction over a system or a system element as per ISO/IEC/IEEE 15288.~                                                                                                                                                                                                                                                        | ~[Element] should not be directly instantiated, instead use one of its subclasses.~                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:InputTerminal~        | ~Input Terminal~                           | ~owl:Class~              | ~testing~  | ~An [Input Terminal] is a [Terminal] that accepts input (and not output).~                                                                                                                                                                                                                                                                                   |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:OutputTerminal~       | ~Output Terminal~                          | ~owl:Class~              | ~testing~  | ~An [Output Terminal] is a [Terminal] that accepts output (and not input).~                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:ProvenanceQualifier~  | ~Provenance Qualifier~                     | ~owl:Class~              | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:RangeQualifier~       | ~Range Qualifier~                          | ~owl:Class~              | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:RegularityQualifier~  | ~Regularity Qualifier~                     | ~owl:Class~              | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:ScopeQualifier~       | ~Scope Qualifier~                          | ~owl:Class~              | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:Terminal~             | ~Terminal~                                 | ~owl:Class~              | ~testing~  | ~A [Terminal] is an [Element] that represents a point of interation or communication for a given [Block] (through the relation [has terminal]), and hence specifies an input and/or output that the [Block] produces and/or receives.~                                                                                                                       |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:TerminalFlow~         | ~Terminal Flow~                            | ~owl:Class~              | ~testing~  | ~[Terminal Flow] is a characteristic of the flow of the [medium] of a [Terminal].~                                                                                                                                                                                                                                                                           |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:value~                | ~value~                                    | ~owl:DatatypeProperty~   | ~testing~  | ~[value] relates an [Attribute] *A* to literal value *v* to specify that *A* has the value *v*.~                                                                                                                                                                                                                                                             |                                                                                                                                                                                                                                                                      | ~The [value] of an [Attribute] "Weight: 1250 kg" could be specified as the literal "1250"^^xsd:integer (or using a different appropriate literal datatype).~                                                                                                                    |                                                                                                                                                                                                                                                                             |
| ~imf:absoluteQualifier~    | ~absolute~                                 | ~owl:NamedIndividual~    | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:averageQualifier~     | ~average~                                  | ~owl:NamedIndividual~    | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:calculatedQualifier~  | ~calculated~                               | ~owl:NamedIndividual~    | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:continuousQualifier~  | ~continuous~                               | ~owl:NamedIndividual~    | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:designQualifier~      | ~design~                                   | ~owl:NamedIndividual~    | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:inputFlow~            | ~input flow~                               | ~owl:NamedIndividual~    | ~testing~  | ~[input flow] is a [Terminal Flow] that indicates that the flow is incoming to the [Terminal] is characterises.~                                                                                                                                                                                                                                             |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:maximumQualifier~     | ~maximum~                                  | ~owl:NamedIndividual~    | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:measuredQualifier~    | ~measured~                                 | ~owl:NamedIndividual~    | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:minimumQualifier~     | ~minimum~                                  | ~owl:NamedIndividual~    | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:nominalQualifier~     | ~nominal~                                  | ~owl:NamedIndividual~    | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:normalQualifier~      | ~normal~                                   | ~owl:NamedIndividual~    | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:operatingQualifier~   | ~operating~                                | ~owl:NamedIndividual~    | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:outputFlow~           | ~output flow~                              | ~owl:NamedIndividual~    | ~testing~  | ~[input flow] is a [Terminal Flow] that indicates that the flow is outgoing from the [Terminal] is characterises.~                                                                                                                                                                                                                                           |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:specifiedQualifier~   | ~specified~                                | ~owl:NamedIndividual~    | ~testing~  |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:associativeRelation~  | ~associative relation~                     | ~owl:ObjectProperty~     | ~testing~  | ~[associative relation] is a generic relation that relates resources in an associative (or non-hierarchical) structure.~                                                                                                                                                                                                                                     |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:classifier~           | ~classifier~                               | ~owl:ObjectProperty~     | ~testing~  | ~[classifier] is an [external reference] that relates an [Element] *E* to a resource *X* in an external ontology or reference data library such that *X* classifies *E* -- or equivalently, *E* is an instance of *X*.~                                                                                                                                      |                                                                                                                                                                                                                                                                      | ~[classifier] is used to relate a [Block] that is specified to perform a pumping function to the external resource PUMPING <https://data.posccaesar.org/rdl/RDS9657917>. We then say that the [Block] is classified by PUMPING, or that the [Block] is an instance of PUMPING.~ |                                                                                                                                                                                                                                                                             |
| ~imf:connectedTo~          | ~connected to~                             | ~owl:ObjectProperty~     | ~testing~  | ~[connected to] is an [associative relation] and an [intra-aspect relation] that relates a [Terminal] *T1* to a [Terminal] *T2* to specify that *T1* is connected to *T2*. [connected to] specifies a topology of [Element]s by relating the [Terminal]s of [Block]s and hence describes how [Block]s are interconnected and indicates how they interact.~   | ~[connected to] is a 1-1 relationship: a [Terminal] may only be [connected to] one other [Terminal], that is, a [Terminal] may not be [connected to] multiple [Terminal]s and it may not be [connected to] itself.~                                                  |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:externalReference~    | ~external reference~                       | ~owl:ObjectProperty~     | ~testing~  | ~[external reference] is a generic relation that relates a resource *X* to a resource in an external ontology or reference data library for added semantic description of *X*.~                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:hasAspect~            | ~has aspect~                               | ~owl:ObjectProperty~     | ~testing~  | ~[has aspect] is a relation from an [Aspect Element] *E* to an [Aspect] *A* that specfies that *E* has the [Aspect] *A*.~                                                                                                                                                                                                                                    |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:hasAttribute~         | ~has attribute~                            | ~owl:ObjectProperty~     | ~testing~  | ~[has attribute] is a relation between a resource *X* and an [Attribute] *A* that specifies that *X* has the attribute *A*.~                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:hasAttributeGroup~    | ~has attribute group~                      | ~owl:ObjectProperty~     | ~testing~  | ~[has attribute group] is a relation between a resource *X* and an [Attribute Group] *A* that specifies that *X* has the attribute group *A*.~                                                                                                                                                                                                               |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 | ~See comment on [Attribute Group], does [has attribute group] represent a "long-hand property" meaning that attaching the Attributes of the Attribute Group directly is equivalent? Perhaps the functionality of [Attribute Group]s is best realised as aspect-less-types?~ |
| ~imf:hasFlowDirection~     | ~has terminal flow~                        | ~owl:ObjectProperty~     | ~testing~  | ~[has terminal flow] relates a [Terminal] *T* to a [Terminal Flow] *F* to specify that *T* has the flow characteristic *F*.~                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:hasInputTerminal~     | ~has input terminal~                       | ~owl:ObjectProperty~     | ~testing~  | ~[has input terminal] specialises the [has terminal] property to relate [Block]s to [InputTerminal]s.~                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:hasOutputTerminal~    | ~has output terminal~                      | ~owl:ObjectProperty~     | ~testing~  | ~[has output terminal] specialises the [has terminal] property to relate [Block]s to [Output Terminal]s.~                                                                                                                                                                                                                                                    |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:hasPart~              | ~has part~                                 | ~owl:ObjectProperty~     | ~testing~  | ~[has part] is a [hierarchical relation] and an [intra-aspect relation] that is the inverse relation of [part of].~                                                                                                                                                                                                                                          | ~Use [has part] when you want to specify the [Element]s that are part of an [Element] *E* "on *E*", rather than using the inverse property [part of] to state that the [part of] relationship to *E* for every [Element] that is part of *E*.~                       |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:hasQualifier~         | ~has qualifier~                            | ~owl:ObjectProperty~     | ~testing~  | ~[has qualifier] is a relation between an [Attribute] *A* and an [Attribute Qualifier] *Q* to specify that *A* is qualified by *Q*.~                                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:hasTerminal~          | ~has terminal~                             | ~owl:ObjectProperty~     | ~testing~  | ~[has terminal] is an [associative relation] and an [intra-aspect relation] that relates a [Block] *B* to a [Terminal] *T* to specify that *T* is a terminal of, or belongs to, *B*. [has terminal] is an inverse functional property which means that a [Terminal] may only belong to one [Block].~                                                         |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:hierarchicalRelation~ | ~hierarchical relation~                    | ~owl:ObjectProperty~     | ~testing~  | ~[hierarchical relation] is a generic relation that relates resources in a hierarchical or tree-shaped structure.~                                                                                                                                                                                                                                           |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:interAspectRelation~  | ~inter-aspect relation~                    | ~owl:ObjectProperty~     | ~testing~  | ~[inter-aspect relation] a generic relation between [Aspect Element]s *E1* and *E2* such that *E1* and *E2* have different [Aspect]s.~                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:intraAspectRelation~  | ~intra-aspect relation~                    | ~owl:ObjectProperty~     | ~testing~  | ~[intra-aspect relation] a generic relation between [Aspect Element]s *E1* and *E2* such that *E1* and *E2* have the same [Aspect].~                                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:medium~               | ~medium~                                   | ~owl:ObjectProperty~     | ~testing~  | ~[medium] is an [external reference] that relates a [Terminal] *T* to a resource *X* to specify that *X* is the medium that flows through *T*.~                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      | ~[medium] is typically used to relate a [Terminal] to an resource that specifies one of the following:Material (Fluid, Solids)Energy (Mechanical, Electrical, Thermal)Force (Mechanical)Information(Electrical, Optical, Wireless)~                                             |                                                                                                                                                                                                                                                                             |
| ~imf:partOf~               | ~part of~                                  | ~owl:ObjectProperty~     | ~testing~  | ~[part of] is a [hierarchical relation] and an [intra-aspect relation] that relates an [Element] *E1* and an [Element] *E2* to specify that *E1* is part of *E2*, or equivalently that *E2* has *E1* as a part. [part of] is used to specify a breakdown hierarchy of [Element]s.~                                                                           | ~"An [Element] may only have one 'parent'": [part of] is functional and irreflexive property which means that any [Element] may only be part of one other [Element], that is: an [Element] may not be part of multiple [Element]s and it may not be part of itself.~ |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:property~             | ~property~                                 | ~owl:ObjectProperty~     | ~testing~  | ~[property] is an [external reference] that relates an [Attribute] *A* to a resource *X* to specify that *A* has the property *X*.~                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                      | ~The [property] of an [Attribute] "Weight: 1250 kg" could be specified as WEIGTH <http://data.posccaesar.org/rdl/RDS356894>.~                                                                                                                                                   |                                                                                                                                                                                                                                                                             |
| ~imf:uom~                  | ~unit of measure~                          | ~owl:ObjectProperty~     | ~testing~  | ~[unit of measure] is an [external reference] that relates an [Attribute] *A* to a resource *X* to specify that *A* has the unit of measure *X*.~                                                                                                                                                                                                            |                                                                                                                                                                                                                                                                      | ~The [unit of measure] of an [Attribute] "Weight: 1250 kg" could be specified as KILOGRAM <http://data.posccaesar.org/rdl/RDS1328669>.~                                                                                                                                         |                                                                                                                                                                                                                                                                             |
| ~imf:BreakdownPoint~       | ~Breakdown Point~                          | ~owl:Class~              | ~unstable~ |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:ConnectionPoint~      | ~Connection Point~                         | ~owl:Class~              | ~unstable~ |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:theConnected~         | ~the connected~                            | ~owl:ObjectProperty~     | ~unstable~ |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:theInput~             | ~the input~                                | ~owl:ObjectProperty~     | ~unstable~ |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:theOutput~            | ~the output~                               | ~owl:ObjectProperty~     | ~unstable~ |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:thePart~              | ~the part~                                 | ~owl:ObjectProperty~     | ~unstable~ |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
| ~imf:theWhole~             | ~the whole~                                | ~owl:ObjectProperty~     | ~unstable~ |                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                             |
...
imf:AttributeShape a sh:NodeShape ;
  ...
  sh:property 
    ...
    [ sh:path imf:value ; sh:minCount 1 ; sh:severity sh:Warning ; sh:message "Attribute has no value" ] ,
    [ sh:path imf:uom ; sh:maxCount 1 ] , 
    [ sh:path imf:hasQualifier ; sh:maxCount 1 ; sh:class imf:Regularity ] , 
    [ sh:path imf:hasQualifier ; sh:maxCount 1 ; sh:class imf:Range ] , 
    [ sh:path imf:hasQualifier ; sh:maxCount 1 ; sh:class imf:Provenence ] , 
    [ sh:path imf:hasQualifier ; sh:maxCount 1 ; sh:class imf:Scope ] ,
    [ sh:path imf:hasQualifier ; sh:minCount 1 ; sh:severity sh:Warning ; sh:message "Attribute has no qualifier" ] 
.
imf:AttributeGroupShape a sh:NodeShape ;
  sh:targetClass imf:AttributeGroup ;
...
imf:AttributeShape
    ...
    sh:targetClass imf:Attribute ;
    sh:targetObjectsOf imf:hasAttribute ;
    sh:targetSubjectsOf imf:property, imf:hasQualifier, imf:uom .
...
Generated change log that only checks the occurrence of IRIs between
two versions of ontologies. The report only contains IRIs under the
IMF namespace. This may include the IRIs of the ontologies.

#+CALL: py_iri_rdf_diff(v2="out/owl/imf.owl.ttl", v1="https://ns.imfid.org/20221118/imf-vocabulary.owl.ttl")

#+RESULTS:
 - IRIs in both versions :: ns1:imf, imf:Aspect, imf:AspectElement, imf:Block, imf:InputTerminal, imf:OutputTerminal, imf:Terminal, imf:associativeRelation, imf:color, imf:hasInputTerminal, imf:hasOutputTerminal, imf:hasPart, imf:hasTerminal, imf:hierarchicalRelation, imf:interAspectRelation, imf:intraAspectRelation, imf:prefix, imf:theInput, imf:theOutput

 - IRIs added to v2 :: ns2:imf, imf:Attribute, imf:AttributeGroup, imf:AttributeQualifier, imf:BreakdownPoint, imf:ConnectionPoint, imf:Direction, imf:Element, imf:ProvenanceQualifier, imf:RangeQualifier, imf:RegularityQualifier, imf:ScopeQualifier, imf:absoluteQualifier, imf:aspect, imf:averageQualifier, imf:calculatedQualifier, imf:classifier, imf:connectedTo, imf:continuousQualifier, imf:designQualifier, imf:direction, imf:externalReference, imf:hasAttribute, imf:hasAttributeGroup, imf:hierachicalRelation, imf:inputDirection, imf:maximumQualifier, imf:measuredQualifier, imf:medium, imf:minimumQualifier, imf:nominalQualifier, imf:normalQualifier, imf:operatingQualifier, imf:outputDirection, imf:partOf, imf:property, imf:hasQualifier, imf:since, imf:specifiedQualifier, imf:symbol, imf:theConnected, imf:thePart, imf:theWhole, imf:uom, imf:value

 - IRIs deleted from v2 :: ns3:imf-vocabulary, imf:FunctionAspect, imf:FunctionAspectElement, imf:FunctionBlock, imf:FunctionInterfacePoint, imf:FunctionTerminal, imf:InstalledAspect, imf:InstalledAspectElement, imf:InstalledBlock, imf:InstalledInterfacePoint, imf:InstalledTerminal, imf:InterAspectRelation, imf:InterfacePoint, imf:LocationAspect, imf:LocationAspectElement, imf:LocationBlock, imf:LocationInterfacePoint, imf:LocationTerminal, imf:ProductAspect, imf:ProductAspectElement, imf:ProductBlock, imf:ProductInterfacePoint, imf:ProductTerminal, imf:System, imf:SystemElement, imf:fulfilledBy, imf:fulfills, imf:hasAspect, imf:isConnectedTo, imf:isPartOf, imf:memberOf
...
#+BEGIN_SRC ttl
	...
	FILTER (STRSTARTS(STR(?this), 'http://ns.imfid.org'))
        ...
        FILTER NOT EXISTS { 
	  ?this skos:editorialNote ?note .
	  FILTER (STRSTARTS(STR(?note), 'Generated'))
	}
      }
      ## ORDER BY ?this
#+END_SRC
...
| this                                           |
==================================================
| <http://ns.imfid.org/imf#theWhole>             |
| <http://ns.imfid.org/imf#connectedTo>          |
| <http://ns.imfid.org/imf#theOutput>            |
| <http://ns.imfid.org/imf#partOf>               |
| <http://ns.imfid.org/imf#theInput>             |
| <http://ns.imfid.org/imf#thePart>              |
| <http://ns.imfid.org/imf#calculatedQualifier>  |
| <http://ns.imfid.org/imf#normalQualifier>      |
| <http://ns.imfid.org/imf#maximumQualifier>     |
| <http://ns.imfid.org/imf#inputDirection>       |
| <http://ns.imfid.org/imf#outputDirection>      |
| <http://ns.imfid.org/imf#nominalQualifier>     |
| <http://ns.imfid.org/imf#absoluteQualifier>    |
| <http://ns.imfid.org/imf#minimumQualifier>     |
| <http://ns.imfid.org/imf#averageQualifier>     |
| <http://ns.imfid.org/imf#installedAspect>      |
| <http://ns.imfid.org/imf#specifiedQualifier>   |
| <http://ns.imfid.org/imf#locationAspect>       |
| <http://ns.imfid.org/imf#measuredQualifier>    |
| <http://ns.imfid.org/imf#functionAspect>       |
| <http://ns.imfid.org/imf#continuousQualifier>  |
| <http://ns.imfid.org/imf#operatingQualifier>   |
| <http://ns.imfid.org/imf#productAspect>        |
| <http://ns.imfid.org/imf#designQualifier>      |
| <http://ns.imfid.org/imf#calculatedQualifier>  |
| <http://ns.imfid.org/imf#specifiedQualifier>   |
| <http://ns.imfid.org/imf#measuredQualifier>    |
| <http://ns.imfid.org/imf#absoluteQualifier>    |
| <http://ns.imfid.org/imf#continuousQualifier>  |
| <http://ns.imfid.org/imf#hierarchicalRelation> |
| <http://ns.imfid.org/imf#connectedTo>          |
| <http://ns.imfid.org/imf#partOf>               |
| <http://ns.imfid.org/imf#operatingQualifier>   |
| <http://ns.imfid.org/imf#designQualifier>      |
| <http://ns.imfid.org/imf#Element>              |
| <http://ns.imfid.org/imf#AspectElement>        |
| <http://ns.imfid.org/imf#AttributeGroup>       |
| <http://ns.imfid.org/imf#ConnectionPoint>      |
| <http://ns.imfid.org/imf#Direction>            |
| <http://ns.imfid.org/imf#BreakdownPoint>       |
| <http://ns.imfid.org/imf#ProvenanceQualifier>  |
| <http://ns.imfid.org/imf#RegularityQualifier>  |
| <http://ns.imfid.org/imf#Attribute>            |
| <http://ns.imfid.org/imf#Block>                |
| <http://ns.imfid.org/imf#ScopeQualifier>       |
| <http://ns.imfid.org/imf#AttributeQualifier>   |
| <http://ns.imfid.org/imf#Terminal>             |
| <http://ns.imfid.org/imf#RangeQualifier>       |
| <http://ns.imfid.org/imf#Aspect>               |
| <http://ns.imfid.org/imf#InputTerminal>        |
| <http://ns.imfid.org/imf#OutputTerminal>       |
| <http://ns.imfid.org/imf#value>                |
| <http://ns.imfid.org/imf#color>                |
| <http://ns.imfid.org/imf#symbol>               |
| <http://ns.imfid.org/imf#prefix>               |
| <http://ns.imfid.org/imf#normalQualifier>      |
| <http://ns.imfid.org/imf#maximumQualifier>     |
| <http://ns.imfid.org/imf#nominalQualifier>     |
| <http://ns.imfid.org/imf#minimumQualifier>     |
| <http://ns.imfid.org/imf#averageQualifier>     |
| <http://ns.imfid.org/imf#connectedTo>          |
| <http://ns.imfid.org/imf#hasTerminal>          |
| <http://ns.imfid.org/imf#installedAspect>      |
| <http://ns.imfid.org/imf#locationAspect>       |
| <http://ns.imfid.org/imf#functionAspect>       |
| <http://ns.imfid.org/imf#productAspect>        |
| <http://ns.imfid.org/imf#hierarchicalRelation> |
| <http://ns.imfid.org/imf#intraAspectRelation>  |
| <http://ns.imfid.org/imf#theWhole>             |
| <http://ns.imfid.org/imf#medium>               |
| <http://ns.imfid.org/imf#associativeRelation>  |
| <http://ns.imfid.org/imf#hasPart>              |
| <http://ns.imfid.org/imf#property>             |
| <http://ns.imfid.org/imf#connectedTo>          |
| <http://ns.imfid.org/imf#hasOutputTerminal>    |
| <http://ns.imfid.org/imf#qualifier>            |
| <http://ns.imfid.org/imf#hasAttribute>         |
| <http://ns.imfid.org/imf#theOutput>            |
| <http://ns.imfid.org/imf#interAspectRelation>  |
| <http://ns.imfid.org/imf#partOf>               |
| <http://ns.imfid.org/imf#hasAttributeGroup>    |
| <http://ns.imfid.org/imf#theConnected>         |
| <http://ns.imfid.org/imf#aspect>               |
| <http://ns.imfid.org/imf#theInput>             |
| <http://ns.imfid.org/imf#classifier>           |
| <http://ns.imfid.org/imf#externalReference>    |
| <http://ns.imfid.org/imf#uom>                  |
| <http://ns.imfid.org/imf#thePart>              |
| <http://ns.imfid.org/imf#hasInputTerminal>     |
| <http://ns.imfid.org/imf#direction>            |
| <http://ns.imfid.org/imf#hasTerminal>          |
--------------------------------------------------
#+end_example
...
Node=<http://shipshape.dyreriket.xyz#ANY_NODE>
  Value: rdf:XXXrest
  Message: Unrecognised RDF vocabulary element. Check spelling.
Node=<http://shipshape.dyreriket.xyz#ANY_NODE>
  Value: rdf:XXXfirst
  Message: Unrecognised RDF vocabulary element. Check spelling.
#+END_src
...
output += " - IRIs in both versions :: " + ", ".join(prepare(inboth)) + "\n\n"
output += " - IRIs added to v2 :: " + ", ".join(prepare(added)) + "\n\n"
output += " - IRIs deleted from v2 :: " + ", ".join(prepare(deleted))

return output
#+END_SRC

#+RESULTS: py_rdf_diff
 - IRIs in both versions :: ns1:imf, Aspect, AspectElement, Block, FunctionBlock, FunctionTerminal, InputTerminal, InstalledBlock, InstalledTerminal, LocationBlock, LocationTerminal, OutputTerminal, ProductBlock, ProductTerminal, Terminal, associativeRelation, color, hasInputTerminal, hasOutputTerminal, hasPart, hasTerminal, hierarchicalRelation, interAspectRelation, intraAspectRelation, prefix, theInput, theOutput

 - IRIs added to v2 :: ns2:imf, ns2:imf-aspects, ns2:imf-attributes, ns2:imf-elements, Attribute, AttributeGroup, AttributeQualifier, BreakdownPoint, ConnectionPoint, Direction, Element, FunctionElement, InstalledElement, LocationElement, ProductElement, ProvenanceQualifier, RangeQualifier, RegularityQualifier, ScopeQualifier, absoluteQualifier, asFunction, asInstalled, asLocation, asProduct, aspect, averageQualifier, calculatedQualifier, classifier, connectedTo, continuousQualifier, designQualifier, direction, externalReference, functionAspect, hasAttribute, hasAttributeGroup, hierachicalRelation, inputDirection, installedAspect, locationAspect, maximumQualifier, measuredQualifier, medium, minimumQualifier, nominalQualifier, normalQualifier, operatingQualifier, outputDirection, partOf, productAspect, property, qualifier, specifiedQualifier, symbol, theConnected, thePart, theWhole, uom, value, ns1:imf-aspects, ns1:imf-attributes, ns1:imf-elements

 - IRIs deleted from v2 :: ns3:imf-vocabulary, FunctionAspect, FunctionAspectElement, FunctionInterfacePoint, InstalledAspect, InstalledAspectElement, InstalledInterfacePoint, InterAspectRelation, InterfacePoint, LocationAspect, LocationAspectElement, LocationInterfacePoint, ProductAspect, ProductAspectElement, ProductInterfacePoint, System, SystemElement, fulfilledBy, fulfills, hasAspect, isConnectedTo, isPartOf, memberOf
IRIs in both versions: ns1:imf, Aspect, AspectElement, Block, FunctionBlock, FunctionTerminal, InputTerminal, InstalledBlock, InstalledTerminal, LocationBlock, LocationTerminal, OutputTerminal, ProductBlock, ProductTerminal, Terminal, associativeRelation, color, hasInputTerminal, hasOutputTerminal, hasPart, hasTerminal, hierarchicalRelation, interAspectRelation, intraAspectRelation, prefix, theInput, theOutput
IRIs added to v2: ns2:imf, ns2:imf-aspects, ns2:imf-attributes, ns2:imf-elements, Attribute, AttributeGroup, AttributeQualifier, BreakdownPoint, ConnectionPoint, Direction, Element, FunctionElement, InstalledElement, LocationElement, ProductElement, ProvenanceQualifier, RangeQualifier, RegularityQualifier, ScopeQualifier, absoluteQualifier, asFunction, asInstalled, asLocation, asProduct, aspect, averageQualifier, calculatedQualifier, classifier, connectedTo, continuousQualifier, designQualifier, direction, externalReference, functionAspect, hasAttribute, hasAttributeGroup, hierachicalRelation, inputDirection, installedAspect, locationAspect, maximumQualifier, measuredQualifier, medium, minimumQualifier, nominalQualifier, normalQualifier, operatingQualifier, outputDirection, partOf, productAspect, property, qualifier, specifiedQualifier, symbol, theConnected, thePart, theWhole, uom, value, ns1:imf-aspects, ns1:imf-attributes, ns1:imf-elements
IRIs deleted from v2: ns3:imf-vocabulary, FunctionAspect, FunctionAspectElement, FunctionInterfacePoint, InstalledAspect, InstalledAspectElement, InstalledInterfacePoint, InterAspectRelation, InterfacePoint, LocationAspect, LocationAspectElement, LocationInterfacePoint, ProductAspect, ProductAspectElement, ProductInterfacePoint, System, SystemElement, fulfilledBy, fulfills, hasAspect, isConnectedTo, isPartOf, memberOf
ns1:imf, Aspect, AspectElement, Block, FunctionBlock, FunctionTerminal, InputTerminal, InstalledBlock, InstalledTerminal, LocationBlock, LocationTerminal, OutputTerminal, ProductBlock, ProductTerminal, Terminal, associativeRelation, color, hasInputTerminal, hasOutputTerminal, hasPart, hasTerminal, hierarchicalRelation, interAspectRelation, intraAspectRelation, prefix, theInput, theOutput
['ns1:imf', 'Aspect', 'AspectElement', 'Block', 'FunctionBlock', 'FunctionTerminal', 'InputTerminal', 'InstalledBlock', 'InstalledTerminal', 'LocationBlock', 'LocationTerminal', 'OutputTerminal', 'ProductBlock', 'ProductTerminal', 'Terminal', 'associativeRelation', 'color', 'hasInputTerminal', 'hasOutputTerminal', 'hasPart', 'hasTerminal', 'hierarchicalRelation', 'interAspectRelation', 'intraAspectRelation', 'prefix', 'theInput', 'theOutput']
...
* TODOs [12/46]
 ...
 - [ ] Should connectedTo be symmetric?
